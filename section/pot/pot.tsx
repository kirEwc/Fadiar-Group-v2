  ...
  return (
    <>
       <div className="bg-primary w-full h-[380px] xl:h-[400px] relative">
         ...
         <div id="lorem" className="absolute text-white top-5 left-5 md:mt-10 xl:top-20  xl:left-5  "            >
              <h1 className="text-[28px] sm:text-4xl  2xl:text-5xl font-bold  animate__animated  animate__lightSpeedInLeft">
                <samp className="text-[#D69F04] block">
                  Variedad de productos
                </samp>
                <span>Electrodomésticos</span>
              </h1>
              <p className=" mt-4 w-90 2xl:w-120 text-sm sm:text-base xl:text-xl animate__animated  animate__fadeInUp  [animation-delay:0.5s]">
          ...
          />          
             ...
             <BottomShadow
                    ...
                    className="w-[55%]  h-9 z-10 bottom-[-40] right-35 sm:right-23 md:bottom-[-53]
                     lg:right-45 lg:bottom-[-72]  lg:w-[50%] xl:bottom-[-55] xl:w-[35%] xl:right-65" 
                  />
