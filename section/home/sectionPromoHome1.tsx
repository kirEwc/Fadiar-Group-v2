    ...
    <>
      ...
      <div className="bg-primary w-full h-[380px] xl:h-[400px] relative">
         ...
         <div id="lorem" className="absolute text-white top-5 left-5 md:mt-10 xl:top-20  xl:left-10 2xl:left-40"            >
              <h1 className="text-[28px] sm:text-4xl  xl:text-5xl font-bold">
                <samp className="text-[#D69F04] block">
                  Variedad de productos
                </samp>
                <span>Electrodomésticos</span>
              </h1>
              <p className=" mt-4 w-85 xl:w-120 text-sm sm:text-base xl:text-xl ">
                Lorem ipsum dolor sit amet consectetur adipiscing elit hendrerit
                scelerisque, blandit duis sapien phasellus turpis sem convallis
                imperdiet tempus.
              </p>
        ...
        <div >
          <h1 className="font-['Just_Me_Again_Down_Here'] absolute text-3xl md:text-4xl lg:text-5xl  2xl:text-6xl text-white left-4 sm:left-auto top-55 sm:top-auto sm:bottom-30 sm:right-45 md:bottom-50 md:right-45 lg:bottom-60 right-30 lg:right-70 xl:right-90 xl:bottom-80   ">
            Échale Sazón a la Olla
          </h1>
